...
class Config:
    ...
    FLASKY_ADMIN = os.environ.get('FLASKY_ADMIN') or '1421215708@qq.com'
    HOST = '0.0.0.0'
    PORT = 80
...
class DevelopmentConfig(Config):
    ...
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or '13987610292@sina.cn'
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'keepawayfrom@'
